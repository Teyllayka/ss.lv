...
<template>
   <section class="register text-text">
      <div class="info">
         <div class="right">
            <div class="messages"><h1 v-if="currentStep !== 6">Get Started</h1><h1 v-else>Almost Done!</h1></div>
         <transition class="fields" name="slide-left-right" mode="out-in">
            <div class="input-field" v-if="currentStep === 0">
               ...
               <div class="input-form">
                  ...
                  <input type="text" name="" id="name" v-model="v$.form.name.$model" placeholder="Name">
               </div>
            ...
            <div class="input-field" v-else-if="currentStep === 1">
               <span>And surname</span>
               <div class="input-form"><svg width="26" height="18" viewBox="0 0 24 24" fill="inherit" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z" stroke="inherit" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                  <path d="M12 14C8.13401 14 5 17.134 5 21H19C19 17.134 15.866 14 12 14Z" stroke="inherit" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
               </svg><input type="text" name="" id="surname" v-model="v$.form.surname.$model" placeholder="Surname"></div>
               
               <div class="input-errors" v-for="(error, index) of v$.form.surname.$errors" :key="index">
                  <div class="error-msg">{{ error.$message }}</div>
               </div>
            </div>
            <div class="input-field" v-else-if="currentStep === 2">
               <span>How customers can contact you?</span>
               <div class="input-form"><svg width="26" height="20" viewBox="0 0 24 24" fill="inherit" xmlns="http://www.w3.org/2000/svg">
               ...
               </svg><input type="tel" name="" id="phone" v-model="v$.form.phone.$model" placeholder="Phone Number"></div>
               
               <div class="input-errors" v-for="(error, index) of v$.form.phone.$errors" :key="index">
                  <div class="error-msg">{{ error.$message }}</div>
               </div>
            </div>
            <div class="input-field" v-else-if="currentStep === 3">
               <span>Your Email Address</span>
               <div class="input-form"><svg width="22" height="16" viewBox="0 0 22 16" fill="inherit" xmlns="http://www.w3.org/2000/svg">
               ...
               </svg><input type="email" name="" id="email" v-model="v$.form.email.$model" placeholder="Email Address"></div>
             
               <div class="input-errors" v-for="(error, index) of v$.form.email.$errors" :key="index">
                  <div class="error-msg">{{ error.$message }}</div>
               </div>
            </div>
            <div class="input-field" v-else-if="currentStep === 4">
               <span>And Password</span>
               <div class="input-form"><svg id="password" width="16" height="20" viewBox="0 0 16 20" fill="inherit" xmlns="http://www.w3.org/2000/svg">
               ...
               </svg> <input type="password" name="" id="password" v-model="v$.form.password.$model" placeholder="Password"></div>
              
               <div class="input-errors" v-for="(error, index) of v$.form.password.$errors" :key="index">
                  <div class="error-msg">{{ error.$message }}</div>
               </div>
            </div>
            <div class="input-field" v-else-if="currentStep === 5">
               <span>And are you a</span>
               <div class="radios">
                  <div class="radio">
                     <input type="radio" name="bool" id="bool1" value="person" v-model="v$.form.type.$model" placeholder="bool">
                     <label for="bool1">Person</label>
                  </div>
                  <div class="radio">
                     <input type="radio" name="bool" id="bool2" value="company" v-model="v$.form.type.$model" placeholder="bool">
                     <label for="bool2">Company</label>
                  </div>
               </div>
